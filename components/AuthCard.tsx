...
export default function AuthCard({
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    if (ok) {
      ...
      setErrorMessage('Authentication unsuccessful. Please verify your email and password.');
    }
  };

  const handleInitiateGoogleOAuth = () => {
    // Initiate standard Google OAuth 2.0 flow directly via backend endpoint
    const backendUrl = process.env.NEXT_PUBLIC_API_URL || '';
    const googleAuthUrl = backendUrl.startsWith('http')
      ...
      <div className="text-center mb-6 space-y-1">
        ...
        <p className="text-xs text-[#73685a] leading-relaxed">
          {forgotPasswordView
            ...
            : activeTab === 'signin'
            ? 'Access your private jewellery vault, bespoke commissions, and orders.'
            : 'Register your client account to initiate bespoke commissions and track shipments.'}
        </p>
      </div>
          ...
          {resetEmailSent ? (
            <div className="text-center py-6 space-y-3 bg-[#faf8f5] border border-[#c5b49e]/40 p-5">
              ...
              <button
                ...
                className="mt-2 text-xs text-[#9b7e46] hover:underline uppercase tracking-wider font-semibold cursor-pointer"
              >
                Back to Sign In
              </button>
            </div>
            ...
            >
              ...
              <div className="text-center pt-2">
                <button
                  ...
                  className="text-xs text-[#73685a] hover:text-[#141210] hover:underline cursor-pointer"
                >
                  Return to Sign In
                </button>
              </div>
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 bg-[#ede5d8]/70 p-1 border border-[#c5b49e]/50">
            <button
              ...
              className={`py-2 text-xs uppercase tracking-widest font-medium transition-all cursor-pointer ${
                activeTab === 'signin'
