    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-8 py-12 space-y-10">
      <div className="text-center space-y-3">
        <span className="text-[10px] tracking-[0.35em] text-[#9b7e46] uppercase font-medium">
          Maison Aurelia Longevity Protocol
        </span>
      ...
      <div className="space-y-6">
        <div className="bg-[#faf8f5] border border-[#c5b49e]/40 p-6 sm:p-8 space-y-3">
          ...
          <p className="text-xs text-[#4a4237] leading-relaxed">
            Apply cosmetics, perfumes, lotions, and hairspray before putting on your jewellery. Store each creation separately inside its dedicated Aurelia chamois pouch or velvet-lined jewelry chest to prevent gemstones from scratching adjacent precious metal surfaces.
          </p>
        </div>
        ...
        <div className="bg-[#faf8f5] border border-[#c5b49e]/40 p-6 sm:p-8 space-y-3">
          ...
          <p className="text-xs text-[#4a4237] leading-relaxed">
            Every Aurelia piece includes lifetime complimentary annual prong tightening, ultrasonic inspection, and steam polishing at our Place Vendôme atelier or via our insured courier service.
          </p>
        </div>
      </div>
    </div>
