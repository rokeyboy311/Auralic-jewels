    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-8 py-12 space-y-12">
      <div className="text-center space-y-3">
        <span className="text-[10px] tracking-[0.35em] text-[#9b7e46] uppercase font-medium">
          Aurelic Jewels Gemological Dossier
        </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs text-[#4a4237]">
          <div className="space-y-1.5">
            ...
            <p className="leading-relaxed">
              The cut dictates how light refracts within the diamond facets. Aurelic Jewels exclusively selects &apos;Excellent&apos; and &apos;Ideal&apos; cuts to deliver unparalleled brilliance and rainbow fire.
            </p>
          </div>
