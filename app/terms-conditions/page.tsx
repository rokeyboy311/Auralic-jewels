  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-8 py-12 space-y-8 text-xs text-[#4a4237]">
      <div className="text-center space-y-2 border-b border-[#ebdccd] pb-6">
        ...
        <p className="text-[#73685a]">Aurelic Jewels Fine Jewellery International</p>
      </div>
      ...
      <div className="space-y-6 leading-relaxed bg-[#faf8f5] border border-[#c5b49e]/40 p-6 sm:p-10">
        ...
        <section className="space-y-2">
          ...
          <p>
            All fine jewellery pieces sold by Aurelic Jewels are guaranteed 100% genuine and hallmarked in accordance with French and international assay standards. Solitaire diamonds are accompanied by official GIA or IGI certificates.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            Prices are displayed in your chosen currency and re-calculated dynamically at prevailing real-time exchange rates. Aurelic Jewels reserves the right to correct manifest typographical or pricing errors before order processing.
          </p>
        </section>
