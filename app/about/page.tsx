      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="relative aspect-4/3 w-full bg-[#f5efe6] overflow-hidden border border-[#c5b49e]/40">
          <Image
            ...
            alt="Maison Aurelia Atelier Craftsmanship"
            fill
        ...
        <div className="space-y-6">
          ...
          <p className="text-xs sm:text-sm text-[#4a4237] leading-relaxed">
            Every creation at Maison Aurelia is born from a dialogue between the patron and the master artisan. We do not mass manufacture; our Master Jewellers cast in 18K and 22K gold alloy formulations, meticulously setting each GIA-certified diamond and Colombian emerald under 40x stereoscopic microscopes.
          </p>
          <p className="text-xs sm:text-sm text-[#4a4237] leading-relaxed">
